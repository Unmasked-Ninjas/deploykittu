...
function HelloKitty({ size = 160 }: { size?: number }) {
  return (
    <svg viewBox="0 0 120 105" width={size} height={size * 105 / 120} style={{ filter: 'drop-shadow(0 6px 18px rgba(255,100,160,0.30))' }}>
      {/* Ears */}
      ...
      {/* loop highlights */}
      <path d="M87,18 C82,13 73,14 75,18 C73,22 82,23 87,18Z" fill="#FF6B8A" opacity="0.45" />
      <path d="M87,18 C92,13 101,14 99,18 C101,22 92,23 87,18Z" fill="#FF6B8A" opacity="0.45" />
      {/* knot */}
...
/* ── Decorative bow SVG ── */
function MiniKittyBow({ size = 28, color = '#FF2D55' }: { size?: number; color?: string }) {
  return (
...
export default function LoginPage({ onLogin }: Props) {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(160deg, #FFF0F8 0%, #FFD6EE 45%, #FFC2E2 100%)',
    ...
    >
      ...
      <svg className="absolute inset-0 w-full h-full pointer-events-none" style={{ opacity: 0.18 }}>
        {DOTS.map((d, i) => (
          <circle key={i} cx={`${d.x}%`} cy={`${d.y}%`} r={d.r} fill="#FF6EB4" />
        ))}
      </svg>
      ...
      <AnimatePresence mode="wait">
        ...
        {step === 'password' && (
          ...
          >
            {/* Hello Kitty face */}
            <div className="flex justify-center mb-4" style={{ animation: 'kitty-bounce 2.4s ease-in-out infinite' }}>
              <HelloKitty size={148} />
            </div>
            ...
            <div
              ...
              style={{
                ...
                boxShadow: '0 8px 48px rgba(255,100,160,0.22), 0 2px 8px rgba(255,100,160,0.10)',
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="relative">
                  <input
                    ...
                    onFocus={e => {
                      ...
                      e.target.style.boxShadow = '0 0 0 4px rgba(255,110,180,0.12)';
                    }}
                    onBlur={e => {
                ...
                <AnimatePresence>
                  {error && (
                    <motion.p
                      ...
                      animate={{ opacity: 1, y: 0, animation: 'kitty-shake 0.4s ease' }}
                      exit={{ opacity: 0 }}
                      className="text-center text-sm"
                      style={{ color: '#FF4D9E', fontFamily: "'Nunito', sans-serif", fontWeight: 600 }}
                    >
                      {error}
                    </motion.p>
                  )}
                ...
                <button
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #FF6EB4 0%, #FF4D9E 60%, #FF85C2 100%)',
                    color: 'white',
                    fontFamily: "'Nunito', sans-serif",
                    fontWeight: 800,
                    fontSize: '1rem',
                  ...
                  onMouseEnter={e => {
                    ...
                    e.currentTarget.style.boxShadow = '0 8px 28px rgba(255,77,158,0.45)';
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.transform = 'scale(1)';
                    e.currentTarget.style.boxShadow = '0 4px 20px rgba(255,77,158,0.35)';
                  }}
                >
                  {loading ? (
                    <>
        ...
        {step === 'identity' && (
          ...
          >
            ...
            <div className="flex justify-center mb-4" style={{ animation: 'kitty-bounce 2.2s ease-in-out infinite' }}>
              <HelloKitty size={120} />
            </div>
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  style={{
                    background: 'linear-gradient(160deg, #FFF0F8 0%, #FFE0F2 100%)',
                    border: '2px solid rgba(255,110,180,0.35)',
                    boxShadow: '0 4px 16px rgba(255,110,180,0.12)',
                  }}
                  onMouseEnter={e => {
                    e.currentTarget.style.transform = 'translateY(-4px) scale(1.03)';
                    e.currentTarget.style.boxShadow = '0 10px 32px rgba(255,77,158,0.28)';
                    e.currentTarget.style.borderColor = '#FF6EB4';
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.transform = 'translateY(0) scale(1)';
                    e.currentTarget.style.boxShadow = '0 4px 16px rgba(255,110,180,0.12)';
                    e.currentTarget.style.borderColor = 'rgba(255,110,180,0.35)';
                  }}
                >
                  <div style={{ fontSize: '2.2rem', marginBottom: '4px' }}>🌸</div>
                  <div style={{ fontFamily: "'Pacifico', cursive", fontSize: '1.25rem', color: '#FF4D9E' }}>
                    Saffy
                  </div>
                  <div style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 600, fontSize: '0.68rem', color: '#FF9BC8', letterSpacing: '0.12em', marginTop: '3px' }}>
                    Nepal 🇳🇵
                  </div>
                </button>
                ...
                <button
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.transform = 'translateY(-4px) scale(1.03)';
                    e.currentTarget.style.boxShadow = '0 10px 32px rgba(120,140,255,0.28)';
                    e.currentTarget.style.borderColor = '#8CA0FF';
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.transform = 'translateY(0) scale(1)';
                    e.currentTarget.style.boxShadow = '0 4px 16px rgba(140,160,255,0.12)';
                    e.currentTarget.style.borderColor = 'rgba(140,160,255,0.35)';
                  }}
                >
                  <div style={{ fontSize: '2.2rem', marginBottom: '4px' }}>💙</div>
                  <div style={{ fontFamily: "'Pacifico', cursive", fontSize: '1.25rem', color: '#5B7BFF' }}>
                    Prasannu
                  </div>
                  <div style={{ fontFamily: "'Nunito', sans-serif", fontWeight: 600, fontSize: '0.68rem', color: '#8CA0FF', letterSpacing: '0.12em', marginTop: '3px' }}>
                    Sydney 🇦🇺
                  </div>
                </button>
              </div>
